...
interface GroovyBuilderScope : GroovyObject {
    ...
    companion object {
        ...
        fun of(value: Any): GroovyBuilderScope = when (value) {
...
private class GroovyBuilderScopeForGroovyObject(
...
private class GroovyBuilderScopeForRegularObject(override val delegate: Any) : GroovyBuilderScope {
    ...
    private val groovyMetaClass: MetaClass by lazy {
